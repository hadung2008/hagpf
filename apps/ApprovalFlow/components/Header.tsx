                    ...
                    <div className="flex items-center space-x-2 sm:space-x-4 flex-shrink-0">
                        {hasPermission('approvalFlow.requests.CREATE') && (
                            <button
                                ...
                                className="inline-flex items-center justify-center p-2 sm:px-3 sm:py-1.5 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors"
                                title={t('approvalFlow.header.newRequest')}
                            >
                                <PlusCircleIcon className="w-5 h-5 sm:mr-1.5" />
                                <span className="hidden sm:inline">{t('approvalFlow.header.newRequest')}</span>
                            </button>
                        )}
                        <LanguageSwitcher />
