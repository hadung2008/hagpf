                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-slate-400 uppercase">{t('repairShop.products.stockHeader')}</th>
                                        <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 dark:text-slate-400 uppercase">{t('repairShop.products.priceHeader')}</th>
                                ...
                                <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                                    {filteredProducts.map(product => (
                                        <tr key={product.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50">
                                            ...
                                            <td className="px-4 py-3 whitespace-nowrap text-sm text-center font-bold text-gray-700 dark:text-slate-300">
                                                {isLowStock(product.stock) ? <span className="px-2 py-1 bg-yellow-100 dark:bg-yellow-500/10 text-yellow-800 dark:text-yellow-400 rounded-full">{product.stock} ({t('repairShop.products.lowStock')})</span> : <span>{product.stock}</span>}
                                            </td>
