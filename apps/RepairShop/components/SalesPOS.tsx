...
export const SalesPOS: React.FC<SalesPOSProps> = ({ products, setProducts, customers, setCustomers, onCheckout, categories }) => {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-200px)]">
            {/* Products Panel */}
            <div className="lg:col-span-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg flex flex-col overflow-hidden">
            ...
            {/* Cart Panel */}
            <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg flex flex-col overflow-hidden">
