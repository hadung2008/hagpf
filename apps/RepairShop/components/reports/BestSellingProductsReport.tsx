        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{t('repairShop.reports.bestSellingTitle')} & Parts</h1>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-6">
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                         <thead><tr><th className="py-2 text-left text-xs font-medium text-gray-500 dark:text-slate-400 uppercase">{t('repairShop.reports.productHeader')}</th><th className="py-2 text-right text-xs font-medium text-gray-500 dark:text-slate-400 uppercase">{t('repairShop.reports.unitsSoldHeader')}</th><th className="py-2 text-right text-xs font-medium text-gray-500 dark:text-slate-400 uppercase">{t('repairShop.reports.totalProfitHeader')}</th><th className="py-2 text-right text-xs font-medium text-gray-500 dark:text-slate-400 uppercase">{t('repairShop.reports.revenueHeader')}</th></tr></thead>
                        <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                            {reportData.topSellingProducts.map(p => (<tr key={p.name}>
                                <td className="py-2 text-sm text-gray-800 dark:text-slate-200">{p.name}</td>
                                <td className="py-2 text-sm text-right font-bold text-gray-700 dark:text-slate-300">{p.quantity}</td>
                                <td className="py-2 text-sm text-right text-teal-600 dark:text-teal-400">${p.profit.toFixed(2)}</td>
                                <td className="py-2 text-sm text-right text-green-600 dark:text-green-400">${p.revenue.toFixed(2)}</td>
                            </tr>))}
                        </tbody>
                    </table>
                </div>
                <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-6">
                    <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">{t('repairShop.reports.top10Parts')}</h2>
                     <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                        <thead><tr><th className="py-2 text-left text-xs font-medium text-gray-500 dark:text-slate-400 uppercase">{t('repairShop.reports.partHeader')}</th><th className="py-2 text-right text-xs font-medium text-gray-500 dark:text-slate-400 uppercase">{t('repairShop.reports.unitsUsedHeader')}</th><th className="py-2 text-right text-xs font-medium text-gray-500 dark:text-slate-400 uppercase">{t('repairShop.reports.totalProfitHeader')}</th></tr></thead>
                        <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
