                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                        {permissionFunctions.map(func => (
                           <React.Fragment key={func.id}>
                                <tr className="group bg-white dark:bg-slate-800">
                                    <td className="sticky left-0 bg-white dark:bg-slate-800 group-hover:bg-gray-50 dark:group-hover:bg-slate-700/50 z-10 px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-slate-200 border-r border-gray-200 dark:border-slate-700">
                                    ...
                                    {allActions.map(action => {
                                         ...
                                         return (
                                            <td key={action.id} className={`px-4 py-3 whitespace-nowrap text-sm text-center group-hover:bg-gray-50 dark:group-hover:bg-slate-700/50 ${isFirstInGroup ? 'border-l border-gray-200 dark:border-slate-700' : ''}`}>
