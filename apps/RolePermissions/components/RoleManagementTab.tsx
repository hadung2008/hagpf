                        ...
                        {permissionFunctions.map(func => {
                            ...
                            return (
                               <React.Fragment key={func.id}>
                                    <tr className="group bg-white dark:bg-slate-800/50">
                                        <td className="sticky left-0 bg-white dark:bg-slate-800/50 group-hover:bg-gray-50 dark:group-hover:bg-slate-700/50 z-10 px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-slate-200 border-r border-gray-200 dark:border-slate-700">
                                        ...
                                        {permissionActions.map(action => {
                                            ...
                                            return (
                                                <td key={action.id} className="px-4 py-3 whitespace-nowrap text-sm text-center group-hover:bg-gray-50 dark:group-hover:bg-slate-700/50">
                                    ...
                                    {isParent(func) && expandedFunctions[func.id] && func.subFunctions!.map(subFunc => (
                                         <tr key={subFunc.id} className="group bg-white dark:bg-slate-800">
                                            <td className="sticky left-0 bg-white dark:bg-slate-800 group-hover:bg-gray-50 dark:group-hover:bg-slate-700/50 z-10 px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-slate-300 border-r border-gray-200 dark:border-slate-700">
