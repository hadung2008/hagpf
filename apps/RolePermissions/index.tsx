        ...
        <div className="min-h-screen bg-gray-100 dark:bg-slate-900 text-gray-800 dark:text-slate-300 font-sans">
            ...
            <main className="p-4 sm:p-6 lg:p-8">
                <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap items-center gap-2 border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 rounded-lg p-2">
                        {navItems.map((item) => (
                            <button
                                key={item.id}
                                onClick={() => setActiveTab(item.id)}
                                className={`flex-grow sm:flex-none flex items-center justify-center px-4 py-2 text-sm font-semibold rounded-md transition-colors duration-200 ${
                                    activeTab === item.id
